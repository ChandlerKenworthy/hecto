...
pub struct Editor {
    should_quit: bool,
    location: Location // current location of the mouse cursor
}
...
impl Editor {
    ...
    fn move_point(&mut self, key_code: KeyCode) -> Result<(), Error> {
        ...
        match key_code {
            KeyCode::Up => {
                // Prevent cursor from going to high up or to the left using saturating subtractions since Position
                // is a usize the minimum is at (0,0), i.e. the top left of the pane.
